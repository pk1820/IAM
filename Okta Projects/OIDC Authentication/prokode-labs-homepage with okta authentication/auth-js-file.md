# Create auth.js - Okta Authentication Logic

Create a new file called `auth.js` with the following authentication logic:
 ...
 */
const oktaConfig = {
    baseUrl: 'https://YOUR_OKTA_DOMAIN.okta.com', // Replace with your Okta domain (e.g., 'https://dev-123456.okta.com')
    clientId: 'YOUR_CLIENT_ID', // Replace with your Client ID from Okta app integration
    redirectUri: window.location.origin,
    authParams: {
        issuer: 'https://YOUR_OKTA_DOMAIN.okta.com/oauth2/default', // Replace with your issuer URL
...
**Replace these placeholders in the auth.js file:**

1. **YOUR_OKTA_DOMAIN** - Your actual Okta domain (e.g., `dev-123456.okta.com`)
2. **YOUR_CLIENT_ID** - The Client ID from your Okta app integration
